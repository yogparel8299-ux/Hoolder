import { DatasetUploadFields } from "../../../components/dataset-upload";
    ...
    <div className="container">
      <div className="page-header">
        <div>
          ...
          <p>
            Dataset listing is free. Hoolder takes a marketplace cut only when a
            dataset is sold.
          </p>
        </div>
      </div>

      <form action={createDataset} className="grid" style={{ maxWidth: 760 }}>
        <div className="card grid">
          ...
          <input className="input" name="file_url" placeholder="Optional external dataset URL" />
        </div>
